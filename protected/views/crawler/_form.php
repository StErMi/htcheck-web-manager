...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div id="tabs">
	<ul>
		<li><a href="#tabs-1">Informazioni Generali</a></li>
	...
	<div id="tabs-1">
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'title',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'Enter the Crawler\'s Mnemonic Title')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textArea($model,'config_header',array('cols'=>70,'rows'=>5, 'class'=>'qtipped', 'title'=>'Enter the configuration header (loaded before htcheck config)')); ?>
			<?php echo $form->error($model,'config_header'); ?>
		</div>
		
		<div class="row">
			<?php echo $form->labelEx($model,'config_footer'); ?>
			<?php echo $form->textArea($model,'config_footer',array('cols'=>70,'rows'=>5, 'class'=>'qtipped', 'title'=>'Enter the configuration footer (loaded after htcheck config)')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'start_url',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'This is the list of URLs that will be used to start a dig when there was no existing database. Note that multiple URLs can be given here.')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'limit_urls_to',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'This specifies a set of patterns that all URLs have to
						...
						EXAMPLE limit_urls_to: .sdsu.edu kpbs')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'limit_normalized',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'This specifies a set of patterns that all URLs have to
					...
					after the URL is normalized. EXAMPLE limit_normalized: http://www.mydomain.com')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'exclude_urls',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'If a URL contains any of the space separated patterns,
						...
						EXAMPLE exclude_urls: students.html cgi-bin')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'max_urls_count',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'Maximum number of URLs to be parsed 
						...
						a simple check for existance. Default: -1 (infinite). EXAMPLE max_urls_count: 70')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'bad_extensions',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'This is a list of extensions on URLs which are
						...
						documents as text while they are some binary format. EXAMPLE bad_extensions: .foo .bar .bad')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'bad_querystr',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'This is a list of CGI query strings to be excluded from
						...
						indexed. EXAMPLE bad_querystr: forum=private section=topsecret&amp;passwd=required')); ?>
		...
		<div class="row"> 
			...
			<?php echo $form->checkBox($model,'check_external', array( 'class'=>'qtipped', 'title'=> 'If set to true, htcheck check if external Urls exist or not.
						...
						attributes. External URLs aren\'t parsed. EXAMPLE check_external: true')); ?>
	...
	<div id="tabs-2">
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'db_name',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'Name of the MySQL database to be created or read.')); ?>
			<?php echo $form->error($model,'db_name'); ?>
		</div>
		
		<div class="row">
			<?php echo $form->labelEx($model,'db_name_prepend'); ?>
			<?php echo $form->textField($model,'db_name_prepend',array('size'=>70,'maxlength'=>255)); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'mysql_conf_file_prefix',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'Prefix for the MySQL configuration file to be searched. Default is \'my\' and
						...
						IMPORTANT: only for MySQL 3.23, 4.0, 4.1 and 5.0')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'mysql_conf_group',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'Group to be searched inside the .my.cnf file of MySQL for getting the
						...
						is [client]). EXAMPLE mysql_conf_group: htcheck')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'mysql_db_charset',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'Database charset (charset of the database that will be created by htcheck)
						...
						configure option (compilation time) or - alternatively - the server\'s default. EXAMPLE mysql_db_charset: utf8')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'mysql_client_charset',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'Client charset. Charset to be used by htcheck when sending queries to the
						mysql server. Default value is empty (server\'s setting). EXAMPLE mysql_client_charset: utf8')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'url_index_length',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=>'This number specifies the length of the index of the
						...
						Default value is 64. EXAMPLE url_index_length: -1')); ?>
		...
		<div class="row"> 
			...
			<?php echo $form->checkBox($model,'optimize_db', array( 'class'=>'qtipped', 'title'=> 'Optimize the database tables at the end of the crawl. Disable it if
						the database server doesn\'t support it. Default is \'false\'. EXAMPLE optimize_db: true' )); ?>
		...
		<div class="row"> 
			...
			<?php echo $form->checkBox($model,'sql_big_table_option', array( 'class'=>'qtipped', 'title'=> 'Enable or disable this option that is useful when performing huge queries.
						...
						a \'table is full\' error. Default is \'true\'. EXAMPLE sql_big_table_option: false' )); ?>
	...
	<div id="tabs-3">
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'max_doc_size',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'Maximum size of the document. EXAMPLE max_doc_size:	700000')); ?>
		...
		<div class="row"> 
			...
			<?php echo $form->checkBox($model,'store_only_links', array( 'class'=>'qtipped', 'title'=> 'If set to false, htcheck will store in the DB <every> tag he finds
						...
						(identified by the pair tag: A, attribute: name). EXAMPLE store_only_links: false' )); ?>
		...
		<div class="row"> 
			...
			<?php echo $form->checkBox($model,'store_url_contents', array( 'class'=>'qtipped', 'title'=> 'This attribute allows to store the contents of the parsed URLs.
						...
						to use this only for small crawls. EXAMPLE store_url_contents: true' )); ?>
	...
	<div id="tabs-4">
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'user_agent',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'User Agent for HTTP connections. EXAMPLE user_agent:	ht://check')); ?>
			<?php echo $form->error($model,'user_agent'); ?>
		</div>
		
		<div class="row"> 
			<?php echo $form->labelEx($model,'persistent_connections'); ?>
			<?php echo $form->checkBox($model,'persistent_connections', array( 'class'=>'qtipped', 'title'=> 'HTTP/1.1 persistent connections (if possible on every server). EXAMPLE persistent_connections: true' )); ?>
			<?php echo $form->error($model,'persistent_connections'); ?>
		</div>
		
		<div class="row"> 
			<?php echo $form->labelEx($model,'head_before_get'); ?>
			<?php echo $form->checkBox($model,'head_before_get', array( 'class'=>'qtipped', 'title'=> 'We make a HEAD call before a GET call (HTTP/1.1). EXAMPLE head_before_get: true')); ?>
			<?php echo $form->error($model,'head_before_get'); ?>
		</div>
		
		<div class="row">
			<?php echo $form->labelEx($model,'timeout'); ?>
			<?php echo $form->textField($model,'timeout',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'Connection timeout. EXAMPLE timeout:	3')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'authorization',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'This tells htcheck to send the supplied
					...
					password. EXAMPLE authorization: myusername:mypassword')); ?>
			<?php echo $form->error($model,'authorization'); ?>
		</div>
		
		<div class="row">
			<?php echo $form->labelEx($model,'max_retries'); ?>
			<?php echo $form->textField($model,'max_retries',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'Number of attempts for retrieving a document. EXAMPLE max_retries: 1' )); ?>
			<?php echo $form->error($model,'max_retries'); ?>
		</div>
		
		<div class="row">
			<?php echo $form->labelEx($model,'tcp_wait_time'); ?>
			<?php echo $form->textField($model,'tcp_wait_time',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'Wait time after a connection timeouts. EXAMPLE tcp_wait_time: 1' )); ?>
			<?php echo $form->error($model,'tcp_wait_time'); ?>
		</div>
		
		<div class="row">
			<?php echo $form->labelEx($model,'tcp_max_retries'); ?>
			<?php echo $form->textField($model,'tcp_max_retries',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'And number of retries (TCP layer). EXAMPLE tcp_max_retries: 1' )); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'http_proxy',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'When this attribute is set, all HTTP document
						...
						of the indexing process. Default: empty. EXAMPLE http_proxy: http://proxy.bigbucks.com:3128' )); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'http_proxy_exclude',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'When this is set, URLs matching this will not use the
						...
						near to the digging server and far away. EXAMPLE http_proxy_exclude: http://intranet.foo.com/' )); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'accept_language',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'This attribute allows to restrict the set of natural languages that are
						...
						set empty, no language will be sent and the server default will be returned. EXAMPLE accept_language: en-us en it' )); ?>
			<?php echo $form->error($model,'accept_language'); ?>
		</div>
		
		<div class="row"> 
			<?php echo $form->labelEx($model,'disable_cookies'); ?>
			<?php echo $form->checkBox($model,'disable_cookies', array( 'class'=>'qtipped', 'title'=> 'If set to \'true\', htcheck will disable the HTTP cookies management. EXAMPLE disable_cookies: true')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'cookies_input_file',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'Set the input file to be used when importing cookies for the
						...
						distributed with ht://Check. By default, no input file is read. EXAMPLE cookies_input_file: /tmp/cookies.txt')); ?>
		...
		<div class="row">
			...
			<?php echo $form->textField($model,'url_reserved_chars',array('size'=>70,'maxlength'=>255, 'class'=>'qtipped', 'title'=> 'This string allows to customise the set of characters that can be considered
						...
						are extremely sure of what you are doing). EXAMPLE url_reserved_chars: \\;/?:@&=+\$,._%-x~')); ?>
	...
	<div id="tabs-5">
		...
		<div class="row">
			...
			<?php echo $form->checkBox($model,'summary_anchor_not_found', array( 'class'=>'qtipped', 'title'=> 'Enable or disable the show of the summary of the HTML anchors that
						have not been found. Default is enabled (true). EXAMPLE summary_anchor_not_found: false' )); ?>
		...
		<div class="row">
			...
			<?php echo $form->checkBox($model,'accessibility_checks', array( 'class'=>'qtipped', 'title'=> 'Enable or disable the recognition of accessibility problems, using
					...
					specified in OAC (http://oac.atrc.utoronto.ca). EXAMPLE accessibility_checks: false' )); ?>
