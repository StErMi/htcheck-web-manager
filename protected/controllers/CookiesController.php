...
class CookiesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Cookies'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->IDCookie));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Cookies');
	...
	{
		$model=new Cookies('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Cookies']))
			$model->attributes=$_GET['Cookies'];
	...
	public function loadModel()
	{
		...
		{
			if(isset($_GET['id']))
				$this->_model=Cookies::model()->findbyPk($_GET['id']);
			if($this->_model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='cookies-form')
		{
